# This was the original, more traditional, approach for this script.
# In my opinion, it's also the wrong way to achieve the same results.
# This script does not fully harness the strength of PowerShell.
